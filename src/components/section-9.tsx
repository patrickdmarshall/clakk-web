            ...
            <div className="mt-4 rounded-lg border border-border/50 bg-card/50 p-6">
              ...
              <TabsContent value="breakpoints">
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <p className="border-foreground text-muted-foreground">32% FCR (Basic)</p>
                  <p className="border-foreground text-muted-foreground">52% FCR (Recommended)</p>
                </div>
                <div className="mt-4 space-y-2">
                  <p className="border-foreground text-foreground">
                  ...
                  <p className="border-foreground text-muted-foreground">32% (Optimal)</p>
                  <p className="border-foreground text-foreground">
                    Increased Attack Speed (IAS) (Javelin Throwing Speed)
                  </p>
                  <p className="border-foreground text-muted-foreground">55% IAS (Optimal)</p>
