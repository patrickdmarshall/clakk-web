            ...
            <div className="mt-4 rounded-lg border border-border/50 bg-card/50 p-6">
              ...
              <TabsContent value="breakpoints">
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <p className="border-foreground text-muted-foreground">78%</p>
                  <p className="border-foreground text-muted-foreground">117%</p>
                  <p className="border-foreground text-muted-foreground">200%</p>
                </div>
                <div className="mt-4 space-y-2">
                  <p className="border-foreground text-foreground">
                    &lt;b&gt;Faster Hit Recovery (FHR):&lt;/b&gt;
                  </p>
                  <p className="border-foreground text-muted-foreground">60% (Decent)</p>
