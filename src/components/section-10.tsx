            ...
            <div className="mt-4 p-6 rounded-lg bg-card/50 border border-border/50">
              ...
              <TabsContent value="breakpoints">
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <p className="text-muted-foreground border-foreground">65% IAS (Basic)</p>
                  <p className="text-muted-foreground border-foreground">92% IAS (Optimal)</p>
                </div>
                <div className="mt-4 space-y-2">
                  <p className="border-foreground text-foreground">
                    &lt;b&gt;Faster Hit Recovery (FHR):&lt;/b&gt;
                  </p>
                  <p className="text-muted-foreground border-foreground">52% (Basic)</p>
